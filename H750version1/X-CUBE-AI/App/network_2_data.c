...
#define AI_NETWORK_2_DATA_WEIGHTS_ADDR     (0x90000000)
...
ai_buffer g_network_2_data_map_weights[AI_NETWORK_2_DATA_WEIGHTS_COUNT] = {
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    ...
    218920, NULL, AI_NETWORK_2_DATA_WEIGHTS_ADDR),   /* weights_array */
  };
...
{
  return AI_HANDLE_PTR(AI_NETWORK_2_DATA_WEIGHTS_ADDR);
}
